...
<form id="adminForm" action="<?php echo JRoute::_('index.php'); ?>" method="post" name="adminForm">
    ...
    <?php 
    $new = JRoute::_('index.php?option=com_nutritions&controller=infits&view=infits&task=edit&cid[]=');
    ?>
    <fieldset>
        <table>
            <tr>              
                <td>
                    <input style="font-size: 10px;" placeholder="Buscar Establecimiento de Salud" type="text" name="establec" id="establec" size="100" maxlength="250" value="<?php echo $this->infitss->establec_name; ?>" required autofocus/>
    ...
    <input type="hidden" name="controller" value="infitss" />
    <input type="hidden" name="view" value="infitss" />
</form>
<?php
...
<fieldset>
    ...
    <table class="table table-bordered" style="width: 100%;" border="1">
        ...
        for ($i = 0, $n = count($this->results); $i < $n; $i++) {
            ...
            $link = JRoute::_('index.php?option=com_nutritions&controller=infits&view=infits&task=edit&cid[]=' . $row->id_its);
            $deleteLink = JRoute::_('index.php?option=com_nutritions&controller=infits&task=removeInfits&infitsId=' . $row->id_its);
            ?>
            <tr class="<?php echo "row$k"; ?>">
                ...
                <td style="text-align:center;">
                    ...
                    <!--<a class="glyphicon glyphicon-minus"  href="<?php // echo $deleteLink ?>" />-->
                     ...
                     <a class="glyphicon glyphicon-minus"  href="#" onclick="verifyDelete_infits(<?php echo $row->id_its ?>);return false;" />
