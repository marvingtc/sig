...
class NutritionsViewInfzoo extends JView {
    
    function display($tpl = null) {
        global $mainframe, $option;
        
        $model = $this->getModel();
        $infzoo = & $this->get('Data');
        $results = array();
...
//        $anhos = $model->getDetalleGeneral('33', '211');
        ...
        $lists['resultado_anho'] = JHTML::_('select.genericlist', $anhoArray, 'nu_ano', 'class="inputbox" size="1"', 'value', 'text', $infzoo->nu_ano);
        ...
        $lists['resultado_mes'] = JHTML::_('select.genericlist', $mesArray, 'nu_mes', 'class="inputbox" size="1" onblur="validainfzoorepetido();" ', 'value', 'text', $infzoo->nu_mes);

        $this->assignRef('lists', $lists);
        $this->assignRef('infzoo', $infzoo);
