...
<form id="adminForm" action="<?php echo JRoute::_('index.php'); ?>" method="post" name="adminForm">
    ...
    <?php 
    $new = JRoute::_('index.php?option=com_nutritions&controller=infzoo&view=infzoo&task=edit&Itemid=3&cid[]=');
    ?>
    <fieldset>
        <table>
            <tr>              
                <td>
                    <input style="font-size: 10px;" placeholder="Buscar Establecimiento de Salud" type="text" name="establec" id="establec" size="100" maxlength="250" value="<?php echo $this->infzoos->establec_name; ?>" required autofocus/>
    ...
    <input type="hidden" name="controller" value="infzoos" />
    <input type="hidden" name="view" value="infzoos" />
</form>
<?php
...
<fieldset>
    ...
    <table class="table table-bordered" style="width: 100%;" border="1">
        ...
        for ($i = 0, $n = count($this->results); $i < $n; $i++) {
            ...
            $link = JRoute::_('index.php?option=com_nutritions&controller=infzoo&view=infzoo&task=edit&Itemid=3&cid[]=' . $row->id_zoo);
            $deleteLink = JRoute::_('index.php?option=com_nutritions&controller=infzoo&task=removeInfzoo&infzooId=' . $row->id_zoo);
            ?>
            <tr class="<?php echo "row$k"; ?>">
                ...
                <td style="text-align:center;">
                    ...
                    <!--<a class="glyphicon glyphicon-minus"  href="<?php // echo $deleteLink ?>" />-->
                     ...
                     <a class="glyphicon glyphicon-minus"  href="#" onclick="verifyDelete_infzoo(<?php echo $row->id_zoo ?>);return false;" />
