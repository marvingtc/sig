...
require_once (JPATH_COMPONENT.DS.'tables'.DS.'informeits.php');
require_once (JPATH_COMPONENT.DS.'tables'.DS.'informezoo.php');
require_once (JPATH_COMPONENT.DS.'tables'.DS.'informemeta.php');
require_once (JPATH_COMPONENT.DS.'tables'.DS.'caso.php');
