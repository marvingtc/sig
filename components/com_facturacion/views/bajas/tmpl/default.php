...
<form id="adminForm" action="<?php echo JRoute::_('index.php'); ?>" method="post" name="adminForm">
    ...
    <input type="hidden" name="controller" value="bajas" />
    <input type="hidden" name="view" value="bajas" />    
</form>
        ...
        <table style="width: 100%;" border="1">
            ...
            if (count($this->results) > 0) {
                ...
                for ($i = 0, $n = count($this->results); $i < $n; $i++) {
                    ...
                    $jsonLink = JRoute::_("index.php?option=com_facturacion&controller=bajas&task=crearJson&Itemid=3&id=" . $row->cpe_id_cpe);
                    ?>
                    <tr class="<?php echo "row$k"; ?>">
                        ...
                        <td>
                            <a href="<?php echo $jsonLink; ?>">Json</a>
                        </td>
                    </tr>
                    <?php
                    $k = 1 - $k;
